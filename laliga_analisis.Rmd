...
En este proyecto vamos a estudiar el dataset llamado "combined_data_laliga.csv" ([kaggle - La Liga Match Data](https://www.kaggle.com/datasets/sanjeetsinghnaik/la-liga-match-data/code)) donde se encuentran todos los partidos de la temporada 2014 hasta la temporada 2020, ambas incluidas, con una recopilación de los principales eventos que ocurren en un partido, goles, tiros a puerta, faltas, tarjetas...
...
```{r echo=FALSE}
paste("Versión de R:", R.Version()$version.string)
```
