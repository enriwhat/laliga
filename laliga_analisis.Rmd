...
```{r, fig.align='center', warning=FALSE, fig.height=4, fig.width=15}
...
ggplot(train,aes(x=resultado, color = train$resultado, fill = train$resultado)) + geom_bar() + labs(x = "Resultado", y = "Nº de resultados", title = "Nº de victorias Local / Visitante / Empate") + theme(plot.title = element_text(hjust = 0.5))
...
\
\
```{r fig.align='center', warning=FALSE, fig.height=10, fig.width=15}
