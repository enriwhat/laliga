...
laliga <- mutate(laliga, resultado = ifelse(Home_Team_Goals_Scored-Away_Team_Goals_Scored > 0, 'Local',
                                          ifelse(Home_Team_Goals_Scored-Away_Team_Goals_Scored < 0, 'Visitante', 'Empate')))
```
